<%-- 
    Document   : AgentCustomer
    Created on : 7 May 2023, 3:01:18 am
    Author     : user
--%>
...
<html lang="en">
    <head>
        ...
        <title>MLM/Agent/Customer</title>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="AgentPage.jsp">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      </li><!-- End Profile Page Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="AgentProduct.jsp">
      ...
      <li class="nav-item">
        <a class="nav-link " href="AgentCustomer.jsp">
          <i class="bi bi-card-list"></i>
          <span>Customer</span>
        </a>
        </li><!-- End Register Page Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="AgentOrder.jsp">
          <i class="bi bi-grid"></i>
          <span>Order</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="AgentMMaterial.jsp">
          <i class="bi bi-grid"></i>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav class="d-flex justify-content-center">
        <ol class="breadcrumb">
           <button type="button" class="btn btn-light rounded-pill"><i class="bi bi-person-plus-fill"></i><a href="custAdd.jsp"> Add Customer</a></button>
        </ol>
      </nav>
    </div><!-- End Page Title --> 
        ...
        swal({
           ...
           preConfirm: function() {
               return new Promise(function(resolve){    //Promise() function take care delete process done by ajax
                   ...
                   $.ajax({
                       url:'custDeleteP.jsp',                //ajax codes start for delete data
                       type:'POST',
                       data:'delete='+fruitId,
                       dataType:'JSON'
                   })
                   ...
                   .fail(function(){
                       swal('Oops...', 'Something went wrong !', 'error');    //if process fail on delete.jsp file get JSON response display message "Unable to delete fruit"
                   });
               });
           },
    ...
    function readFruit(){
        $('#load_fruit').load('AgentCustomer.jsp');  //function readFruit() display data through load() function "load('read.jsp')"
    }
    </script>
                <tr>
                    ...
                    <td><%=resultSet.getString("custPnum") %></td>
                    ...
                    <td><div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                              ...
                              <li><a class="dropdown-item" href="custUpdate.jsp?custID=<%=resultSet.getString("custID")%>">Edit Information</a></li>
                              <li><a class="dropdown-item" href="custDelete.jsp?custID=<%=resultSet.getString("custID")%>">Delete Information</a></li>
                            </ul>
                          </div>
                    </td>
                </tr>
