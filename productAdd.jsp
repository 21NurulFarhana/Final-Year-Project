<%-- 
    Document   : productAdd
    Created on : 14 Mar 2023, 12:18:54 am
    Author     : user
--%>
            ...
            <div class="col-lg-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Adding Product!</h5>
                    <p class="text-center small">Enter the information of the product</p>
                  </div>
                  
                    
                  <!-- Floating Labels Form -->
                  <form class="row g-3" action="productAdding.jsp">
                    <div class="col-md-6">
                      <div class="form-floating">
                          <input type="text" class="form-control" name="productID" placeholder="Product Code" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <select class="form-select" name="productCategory" aria-label="Category">
                    ...
                    <div class="col-8">
                      <div class="form-floating">
                        <input class="form-control" placeholder="Product Description" name="productDescription" style="height: 80px;"></textarea>
                        <label for="productDescription">Product Description</label>
                      </div>
                    </div> 
                    <div class="col-md-4">
                      <div class="form-floating">
                          <input type="text" class="form-control" name="weight" placeholder="Weight(g)" required>
                        <label for="weight">Weight(g)</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating">
                          <input type="text" class="form-control" name="price" placeholder="Price(RM)" required>
                    ...
                    <div class="col-md-5">
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input type="date" class="form-control" name="expireDate" placeholder="Expire Date" >
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="staffID" placeholder="Your HQ ID" required>
